defmodule CurrencyConvertion.Users.UsersTest do
  ...
  describe "get_user/1" do
    test "when user_id exists, returns a user" do
    ...
    test "when user_id does not exist, returns an error" do
  ...
  describe "add_transaction/2" do
    ...
    test "when params are incorrect" do
  ...
  describe "transactions/1" do
    ...
    test "when user_id does not exist, returns an empty list" do
